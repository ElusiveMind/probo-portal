...
RUN composer --working-dir=/var/www/html/web require drupal/admin_toolbar:^1.26 drupal/module_filter drupal/smtp drupal/probo:1.x-dev drupal/proboci:1.x-dev
