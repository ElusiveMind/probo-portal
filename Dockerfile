...
RUN composer --working-dir=/var/www/html install drupal/probo:1.x-dev drupal/admin_toolbar:^1.24 drupal/module_filter:^3.1 drupal/smtp:^1.0 drupal/probo:1.x-dev drupal/proboci:1.x-dev
